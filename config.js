...
// Спільний список виключень для "сирих білкових" категорій (сири, ковбаси,
// риба, птиця) — товари, де м'ясне/сирне слово насправді назва СМАКУ,
// начинки чи інгредієнта в готовій страві/снеку/приправі, а не сам продукт.
// excludeKeywords діють лише коли sourceCategory невідома (тобто товар зі
// сторінки знижок, а не з відомої категорії магазину) — інакше товар просто
// підуть у свою справжню категорію нижче по списку (snacks/sauces/frozen/
// sweets/eggs), знайдену за тим самим ключовим словом там.
const PROTEIN_EXCLUDE = ["чипс","снек","сухар","крекер","попкорн","цукерк","печиво","морозиво",
  "яйц","приправ","гамбургер","бургер","ролліні","піца","круасан","суп ","пюре ","бульйон ",
  "млинц","пиріг","арахіс","вермішель","локшина швидк"];
...
module.exports.CATEGORIES = [
  { id: "cheese",   title: "Сири (преміальні, трюфель/спеції)",
    ...
    excludeKeywords: PROTEIN_EXCLUDE },
  ...
  { id: "pasta",    title: "Крупи, макарони, локшина (азійська)",
    keywords: ["макарони","локшина","вермішель","круп","рис ","гречк","вівс","борошн","пластівці","часник гранул"] },
...
// Максимум 7 штук за домовленістю; тут — 5. "Яйця" винесено сюди з основних
// 20 за проханням Лери (не окрема категорія в головному списку).
